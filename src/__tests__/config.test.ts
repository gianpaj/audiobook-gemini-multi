...
describe("config", () => {
	describe("resolveEnvVars", () => {
		...
		// biome-ignore lint/suspicious/noTemplateCurlyInString: test description
		it("should resolve ${VAR_NAME} format", () => {
			process.env.TEST_VAR = "test-value";
			// biome-ignore lint/suspicious/noTemplateCurlyInString: literal placeholder string for testing
	...
	describe("validateConfig", () => {
		...
		it("should error on missing provider", () => {
			// biome-ignore lint/suspicious/noExplicitAny: testing with invalid config
		...
		it("should error on voice without name", () => {
			...
			// biome-ignore lint/suspicious/noExplicitAny: testing with invalid config type
